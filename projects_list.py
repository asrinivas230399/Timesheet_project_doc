...
class ProjectsList:
    ...
    def add_project(self, project_id, project_currency, hourly_rate):
        ...
        if self.billing_manager.validate_billing_currency(project_currency):
            ...
            print(f"Project {project_id} added with currency: {project_currency} and hourly rate: {hourly_rate}")
        else:
            print(f"Failed to add project {project_id} due to currency mismatch.")
